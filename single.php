            ...
            <div class="container lg:w-[800px] mt-[40px] lg:mt-[148px] mx-auto">
                    ...
                    <div class="div flex flex-row items-center justify-between">
                        ...
                        >
                            ...
                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.75154 11.6199L4.9482 7.81655C4.49904 7.36738 4.49904 6.63238 4.9482 6.18322L8.75154 2.37988" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                ...
                <div id="blog-detail-text">
                    ...
                    <div class="container flex flex-col w-full lg:w-[750px] mx-auto">
                        ...
                        <div class="flex w-full items-center justify-center relative lg:px-0 px-3">
                            ...
                            <div id="shareSocial"
                                ...
                                <a href="" target="_blank" class="hover:translate-y-[-8px] hover:scale-105 transition-all">
                                    ...
                                    <svg class="fill-[#989898] hover:fill-[#FF7E0D]" id="instadetailSocial" width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a  href="http://www.twitter.com/share?url=<?php the_permalink(); ?>" target="_blank"
                                    ...
                                    <svg class="fill-[#989898] hover:fill-[#3b82f6]" width="35" height="36" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="flex-col w-full lg:px-[30px] px-[15px]">
                            ...
                            <div class="flex flex-row items-center lg:px-3 mt-8 justify-between w-full">
                                <div
                                    class="flex justify-between items-center px-[13px] py-[8px] rounded-[25px] bg-dataBg w-auto"
                                >
                                    <p class="text-[14px]">
                            ...
                            <div class="flex flex-col w-full gap-[30px] px-[13px] text-justify lg:leading-9 leading-8 text-[14px] mb-[32px]">
                                <?php the_content(); ?>
                            </div>
                  ...
                  توضیحات کوتاه برای هدایت کاربر و جذب آن برای کلیک روی دکمه
                                ...
                                <a
                                    href="https://cafearz.com/" target="_blank" class="bg-white px-[23px] py-[8px] lg:hover:bg-gold text-black font-semibold text-[14px] rounded-[80px]"
                                >
                                    ورود به کافه ارز
                                </a>
                            </div>
                                ...
                                ?>
                                        ...
                                        <?php while ($rel_posts->have_posts()) : $rel_posts->the_post(); ?>
                                            ...
                                            <a href="<?php the_permalink() ?>"
                                               class="flex flex-col relative mb-[32px] gap-[12px] items-center">
                                               <div class="flex flex-col hover:translate-y-[-16px] transition relative items-center">
                                                    <img
                                                    ...
                                                    <div
                                                        class="category-btn absolute bottom-[18px] h-[29px] left-[22px] bg-white flex flex-row items-center mt-[21px] font-bold text-[14px]"
                                                    >
                                                        <?php get_category_post(); ?>
                                                    </div>
                                                </div>
