   ...
   class="flex flex-col mb-[32px] gap-[12px] items-center hover:translate-y-[-16px] transition">
    ...
    >
        <h3 class="font-bold text-[14px] mt-[14px]">
            <h3><?php the_title(); ?></h3>
            <p class="text-[14px] leading-6 text-blogDetail text-center lg:text-justify font-light w-[95%]">
                <?php the_excerpt();?>
            </p>
            <div class="bg-dataBg px-[13px] py-[3px] gap-[6px] rounded-[25px] flex items-center">
